 ...
 * @author ariel
 */
class Transaccion_pei_reverso_parcial extends Transaccion_pei {
...
//        var_dump($operacion_comisiones);
        ...
        if (in_array(self::$mp->get_id_mp(), array(Mp::COSTO_PEI_DEVOLUCION))) {
...
//                    $pag_fix=$diferencia;
   ...
   protected function operacion_comisiones(Mp $mp) {
    ...
    protected function deducir_id_mp_para_costo_asociado($id_mp) {
        return Mp::COSTO_PEI_DEVOLUCION;
    }
