...
var cargando = "<div class='teatro'><img src=\"public/img/backoffice_load.gif\" style=\"width:50px; margin: auto;\"></div>";
//var cargando = "<div class=\"loading\"><img src=\"public/img/backoffice_load.gif\" style=\"width:50px; margin: auto;\"></div>";
// // Nuevo desarrollo
...
function goodModals(){
    var msj = $('.mensaje_log').attr('title');
    console.log(msj);
    if(msj != "" )
        if(msj != undefined){
            msj = $.parseJSON(msj);
