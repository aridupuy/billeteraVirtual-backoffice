...
# Cambio el nombre a la clase para evitar colision con Mp de CobroDigital
class MP_lib {
    ...
    */    
    ...
    public function search_payment($filters, $offset = 0, $limit = 0) {
        ...
        $request = array(
            "uri" => $uri_prefix."/v1/payments/search",
...
class MPRestClient {
    ...
    private static function build_request($request) {
        ...
        curl_setopt($connect, CURLOPT_USERAGENT, "MercadoPago PHP SDK v" . MP_lib::version);
