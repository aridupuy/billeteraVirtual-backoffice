...
class MOLog implements \JsonSerializable
{
    ...
    public function __construct($results) {
        $this->setMessageId($results->messageId);
        $this->setFrom($results->from);
        $this->setCleanText($results->cleanText);
        $this->setReceivedAt($results->receivedAt);
        $this->setKeyword($results->keyword);
        $this->setSmsCount($results->smsCount);
        $this->setText($results->text);
        $this->setTo($results->to);
        return $this;
    }
